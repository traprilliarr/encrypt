...
export type ConversationProviderProps =
  React.PropsWithChildren<conversationProps>;

export const ConversationContext = createContext<ConversationStore | null>(
  null
);
...
export function useConversationStore<T>(
  ...
  if (!store)
    throw new Error("Missing ConversationContext.Provider in the tree");
